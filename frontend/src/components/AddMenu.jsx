...
const AddMenu = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://backend-vercel-inky.vercel.app/api/menu', newMenuItem);
    ...
    const deleteMenu = async (id) => {
        //yes its run
        try {
            const response = await axios.delete(`https://backend-vercel-inky.vercel.app/api/menu/${id}`);
