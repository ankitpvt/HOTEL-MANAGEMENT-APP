...
const AdminPage = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {                             //https://hotel-management-app-backend.vercel.app/
        const response = await axios.get("https://backend-vercel-3slxhsd3m-ankitpvts-projects.vercel.app/api/orders");
  ...
  const deleteOrder = async (orderId) => {
    ...
    try {              //https://hotel-management-app-backend.vercel.app/
      await axios.delete(`https://backend-vercel-3slxhsd3m-ankitpvts-projects.vercel.app/api/orders/${orderId}`);
